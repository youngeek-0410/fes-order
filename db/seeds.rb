...
User.create!(family_name: '木村', given_name: '拓哉', display_name: 'キムタク', email: 'kimutaku@example.com', password: 'password', password_confirmation: 'password', customer_id: customer.id)
